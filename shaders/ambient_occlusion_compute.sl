...
brx_pixel_shader_parameter_end(main)
{
    ...
    brx_float reduction_thread_local = 0.0;
    brx_branch
    ...
    if (0 == reduction_index)
    {
        ...
        brx_store_2d(g_ambient_occlusion_texture[0], brx_int2(brx_group_id.xy), brx_float4(ambient_occlusion, ambient_occlusion, ambient_occlusion, 1.0));
    }
}